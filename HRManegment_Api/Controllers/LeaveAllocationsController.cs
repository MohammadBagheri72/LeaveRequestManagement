...
namespace HRManegment_Api.Controllers
{
    ...
    public class LeaveAllocationsController : ControllerBase
    {
        ...
        {
            return Ok(await _mediator.Send(new CreateLeaveAllocationCommandRequest() { CreateLeaveAllocationDto = leaveAllocation }));
        }
        ...
        {
            var command=new UpdateLeaveAllocationCommandRequest() { UpdateLeaveAllocationDto = leaveAllocation };
